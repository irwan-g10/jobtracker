  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Irwan Gumilar</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview ml-4">
              ...
              <li class="nav-item">
                <a href="{{route('job-positions.index')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Job Position</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('job-resources.index')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Job Resource</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('job-statuses.index')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Job Status</p>
                </a>
              </li>
